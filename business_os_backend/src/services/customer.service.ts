...
// export const getCustomerInvoices = async (customerId: number): Promise<any[]> => {
...
// export const getCustomerPayments = async (customerId: number): Promise<any[]> => {
//     return new Promise((resolve, reject) => {
//         (db as any).all(
