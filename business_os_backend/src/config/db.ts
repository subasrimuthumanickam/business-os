...
const pool = mysql.createPool({
  host: process.env.DB_HOST || '192.168.31.193',
  user: process.env.DB_USER || 'suba',
  // Change process.env.DB_PASSWORD || 'root' to this:
  password: process.env.DB_PASSWORD || 'Suba@123', 
