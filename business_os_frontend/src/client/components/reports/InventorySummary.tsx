...
export default function InventorySummary() {
  ...
  const totalQty = items.reduce((sum, item) => sum + Number(item.quantity_on_hand), 0);
  const totalValue = items.reduce((sum, item) => sum + Number(item.stock_value), 0);
  ...
  return (
    <div className="p-6">
      <h1 className="mb-6 text-2xl font-semibold">Inventory Summary</h1>
