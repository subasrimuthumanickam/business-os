...
// // // // import { X, Package, Tag, Layers, Plus } from 'lucide-react';
...
// // // //   // Quick action states - Only Categories & Collections
...
// // // //   // Quick Action Handlers - Only Categories & Collections
// // // //   const handleCategories = () => setShowCategoriesModal(true);
// // // //   const handleCollections = () => setShowCollectionsModal(true);
...
// // // //                 <p className="text-2xl font-bold text-green-600">$124,567</p>
// // // //               </div>
...
// // // //                       <td className="px-4 py-2 text-sm text-gray-600">{p.available}</td>
// // // //                       <td className="px-4 py-2">
// // // //                         <span className={`px-2 py-1 text-xs rounded-full ${
// // // //                           p.available <= 10 ? 'bg-red-100 text-red-800' :
// // // //                           p.available <= 50 ? 'bg-yellow-100 text-yellow-800' :
// // // //                           'bg-green-100 text-green-800'
// // // //                         }`}>
// // // //                           {p.available <= 10 ? 'Low' : p.available <= 50 ? 'Medium' : 'High'}
// // // //                         </span>
// // // //                       </td>
// // // //                     </tr>
// // // //                   ))}
...
// // // //               {categories.length > 0 ? (
// // // //                 categories.map((cat: string, index: number) => (
// // // //                   <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-blue-300 transition-all hover:shadow-sm">
...
// // // //                       <button className="px-3 py-1 text-xs bg-white border border-gray-300 rounded-md hover:bg-blue-50 hover:border-blue-300 transition-colors text-gray-600 hover:text-blue-600">
// // // //                         Edit
// // // //                       </button>
// // // //                       <button className="px-3 py-1 text-xs bg-white border border-gray-300 rounded-md hover:bg-red-50 hover:border-red-300 transition-colors text-gray-600 hover:text-red-600">
// // // //                         Delete
// // // //                       </button>
// // // //                     </div>
// // // //                   </div>
...
// // // //               {collections.map((collection: string, index: number) => (
// // // //                 <div key={index} className="p-4 border border-gray-200 rounded-lg hover:shadow-md hover:border-purple-300 transition-all">
...
// // // //                       <h3 className="font-medium text-gray-800">{collection}</h3>
// // // //                       <p className="text-xs text-gray-400">0 products in this collection</p>
// // // //                     </div>
// // // //                   </div>
// // // //                   <div className="mt-3 flex gap-2">
// // // //                     <button className="flex-1 px-3 py-1.5 text-xs bg-blue-50 text-blue-600 rounded-md hover:bg-blue-100 transition-colors">
// // // //                       View Products
// // // //                     </button>
// // // //                     <button className="px-3 py-1.5 text-xs bg-red-50 text-red-600 rounded-md hover:bg-red-100 transition-colors">
// // // //                       Delete
// // // //                     </button>
// // // //                   </div>
// // // //                 </div>
...
// // //   const handleRemoveItems = () => setShowRemoveItemsModal(true);
// // //   const handleOptionTypes = () => setShowOptionTypesModal(true);
// // //   const handleCategories = () => setShowCategoriesModal(true);
// // //   const handleCollections = () => setShowCollectionsModal(true);
// // //   const handleProductSettings = () => setShowProductSettingsModal(true);
...
// //   // Quick action states (still used for buttons in the UI)
// //   const [showRemoveItemsModal, setShowRemoveItemsModal] = useState(false);
// //   const [showOptionTypesModal, setShowOptionTypesModal] = useState(false);
// //   const [showCategoriesModal, setShowCategoriesModal] = useState(false);
// //   const [showCollectionsModal, setShowCollectionsModal] = useState(false);
...
// //   // Quick Action Handlers (for buttons in the UI)
// //   const handleRemoveItems = () => setShowRemoveItemsModal(true);
// //   const handleOptionTypes = () => setShowOptionTypesModal(true);
// //   const handleCategories = () => setShowCategoriesModal(true);
// //   const handleCollections = () => setShowCollectionsModal(true);
...
// //       {/* ============================================ */}
// //       {/* QUICK ACTION MODALS - These are still accessible via buttons in the UI */}
// //       {/* ============================================ */}
