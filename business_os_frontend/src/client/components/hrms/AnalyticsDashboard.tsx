...
//   leaveDistribution: { type: string; count: number }[];
...
//         ],
//         attendanceTrend: [
//           { date: 'Week 1', present: 8, absent: 1 },
//           { date: 'Week 2', present: 9, absent: 0 },
//           { date: 'Week 3', present: 7, absent: 2 },
//           { date: 'Week 4', present: 9, absent: 0 },
//         ],
//         leaveDistribution: [
//           { type: 'Annual', count: 3 },
//           { type: 'Sick', count: 2 },
...
//           { level: 'Excellent', count: 2 },
//           { level: 'Good', count: 5 },
//           { level: 'Satisfactory', count: 2 },
//           { level: 'Needs Improvement', count: 1 },
//         ],
//       };
...
//             {[1, 2, 3, 4, 5].map(star => (
//               <svg key={star} className={`w-4 h-4 ${star <= Math.round(analytics.averageRating) ? 'text-yellow-400 fill-yellow-400' : 'text-white/30'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
//           <div className="space-y-3">
//             {analytics.leaveDistribution.map((leave) => (
//               <div key={leave.type}>
//                 <div className="flex justify-between text-sm">
//                   <span className="text-gray-600">{leave.type}</span>
//                   <span className="font-medium text-gray-800">{leave.count}</span>
//                 </div>
//                 <div className="w-full bg-gray-200 rounded-full h-2">
//                   <div 
//                     className="bg-yellow-500 h-2 rounded-full"
//                     style={{ width: `${(leave.count / analytics.leaveDistribution.reduce((sum, l) => sum + l.count, 0)) * 100}%` }}
//                   />
//                 </div>
//               </div>
//             ))}
...
//         {/* Attendance Trend */}
//         <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
//           <h4 className="font-semibold text-gray-800 mb-4">Attendance Trend</h4>
//           <div className="space-y-3">
//             {analytics.attendanceTrend.map((week) => (
//               <div key={week.date}>
//                 <div className="flex justify-between text-sm">
//                   <span className="text-gray-600">{week.date}</span>
//                   <span className="text-gray-600">
//                     {week.present} present / {week.absent} absent
//                   </span>
//                 </div>
...
//               <div key={perf.level}>
//                 <div className="flex justify-between text-sm">
//                   <span className="text-gray-600">{perf.level}</span>
//                   <span className="font-medium text-gray-800">{perf.count}</span>
//                 </div>
//                 <div className="w-full bg-gray-200 rounded-full h-2">
//                   <div 
//                     className={`h-2 rounded-full ${
//                       perf.level === 'Excellent' ? 'bg-green-500' :
//                       perf.level === 'Good' ? 'bg-blue-500' :
//                       perf.level === 'Satisfactory' ? 'bg-yellow-500' :
//                       'bg-red-500'
//                     }`}
//                     style={{ width: `${(perf.count / analytics.totalEmployees) * 100}%` }}
//                   />
//                 </div>
//               </div>
//             ))}
...
//               <p className="text-sm text-gray-600">Sarah Johnson (4.8)</p>
//             </div>
//           </div>
...
//               <p className="text-sm text-gray-600">Takiya Baksh (5 days)</p>
//             </div>
//           </div>
...
//             </svg>
//             <div>
//               <p className="text-sm font-medium text-gray-800">Best Attendance</p>
//               <p className="text-sm text-gray-600">John Smith (98%)</p>
//             </div>
//           </div>
//         </div>
//       </div>
