...
// import { useNavigate } from 'react-router-dom';
// import { useSearch } from '../../../context/SearchContext';
// import { useCompanyProfileView } from '../../../context/CompanyProfileContext'; // adjust path to wherever you place this file
...
//   // 1b. Company profile content-swap trigger (no URL change)
//   const { openCompanyProfile } = useCompanyProfileView();
...
//         {/* Grid icon -> swaps main content area via context (URL stays the same) */}
//         <Grid3X3
//           size={18}
